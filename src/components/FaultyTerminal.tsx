...
function FaultyTerminal({
  ...
  // Listen to window globally for cursor tracking
...
const MemoizedFaultyTerminal = React.memo(FaultyTerminal, (prevProps, nextProps) => {
  const prevGridMul = prevProps.gridMul || [2, 1];
  const nextGridMul = nextProps.gridMul || [2, 1];
  const gridMulEqual = prevGridMul[0] === nextGridMul[0] && prevGridMul[1] === nextGridMul[1];

  return (
    prevProps.scale === nextProps.scale &&
    gridMulEqual &&
    prevProps.digitSize === nextProps.digitSize &&
    prevProps.timeScale === nextProps.timeScale &&
    prevProps.pause === nextProps.pause &&
    prevProps.scanlineIntensity === nextProps.scanlineIntensity &&
    prevProps.glitchAmount === nextProps.glitchAmount &&
    prevProps.flickerAmount === nextProps.flickerAmount &&
    prevProps.noiseAmp === nextProps.noiseAmp &&
    prevProps.chromaticAberration === nextProps.chromaticAberration &&
    prevProps.dither === nextProps.dither &&
    prevProps.curvature === nextProps.curvature &&
    prevProps.tint === nextProps.tint &&
    prevProps.mouseReact === nextProps.mouseReact &&
    prevProps.mouseStrength === nextProps.mouseStrength &&
    prevProps.dpr === nextProps.dpr &&
    prevProps.pageLoadAnimation === nextProps.pageLoadAnimation &&
